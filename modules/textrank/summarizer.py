...
class KeywordSummarizer:
    ...
    """
    def __init__(self, sents=None, tokenize=None, nWordSet = 1, min_count=2,
        window=-1, min_cooccurrence=2, vocab_to_idx=None,
        df=0.85, max_iter=10, verbose=False):

        self.tokenize = tokenize
        self.nWordSet = nWordSet
    ...
    def train_textrank(self, sents, bias=None):
        ...
        g, self.idx_to_vocab = word_graph(sents,
            self.tokenize, self.nWordSet,self.min_count,self.window,
